        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:flex md:ml-10 md:space-x-8">
              <Link to="/browse" className="text-neutral-500 hover:text-rose-500 px-3 py-2 text-sm font-medium transition-colors">Browse Artists</Link>
              <Link to="/client/dashboard" className="text-neutral-500 hover:text-rose-500 px-3 py-2 text-sm font-medium transition-colors">My Bookings</Link>
              <Link to="/" className="text-neutral-500 hover:text-rose-500 px-3 py-2 text-sm font-medium transition-colors">How It Works</Link>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              {isProfileDropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-neutral-100 py-1 z-50">
                  <Link to="/client/dashboard" className="flex items-center px-4 py-2 text-sm text-neutral-700 hover:bg-rose-50 hover:text-rose-600">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white border-b border-neutral-200">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link to="/browse" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-2 rounded-md text-base font-medium text-neutral-900 hover:bg-neutral-50">Browse Artists</Link>
            <Link to="/client/dashboard" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-2 rounded-md text-base font-medium text-neutral-900 hover:bg-neutral-50">My Bookings</Link>
            <Link to="/" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-2 rounded-md text-base font-medium text-neutral-900 hover:bg-neutral-50">How It Works</Link>
          </div>
          <div className="pt-4 pb-3 border-t border-neutral-200">
            <div className="flex items-center px-5">
              ...
              <button className="ml-auto flex-shrink-0 p-1 rounded-full text-neutral-400 hover:text-neutral-500 focus:outline-none relative">
            ...
            <div className="mt-3 px-2 space-y-1">
              <Link to="/client/dashboard" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-2 rounded-md text-base font-medium text-neutral-500 hover:text-neutral-900 hover:bg-neutral-50">My Profile</Link>
